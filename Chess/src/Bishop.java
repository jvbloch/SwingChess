...
public class Bishop extends Piece{
	...
	public Bishop(Player piecesPlayer, int lx, int ly) {
		...
		if(this.getPlayer().name.equals("p1")){//is player 1
			...
			image = new ImageIcon("bishopW.png");
			//System.out.println(image.getDescription());
			
			imageCheck = new File("bishopW.png");
		}
		else{
			image = new ImageIcon("bishopB.png");
			//System.out.println(image.getDescription());
			
			imageCheck = new File("bishopB.png");
		}
